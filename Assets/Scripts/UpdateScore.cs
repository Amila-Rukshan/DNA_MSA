            ...
            case 2:
                switch (stage) {
                    case 0:
                        ...
                        GetComponentsInChildren<Image>()[13].color = new Color(255, 255, 255, 255);
                        GetComponentsInChildren<Image>()[16].color = new Color(255, 255, 255, 255);
                    ...
                    case 1:
                        if (BuildAncestorAndScore.score2 >= par)
                        {
                            ...
                            GetComponentsInChildren<Image>()[17].color = new Color(255, 255, 255, 255);
